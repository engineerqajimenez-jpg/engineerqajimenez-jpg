...
### 🧪 Testing Manual
![Manual Testing](https://img.shields.io/badge/Manual%20Testing-✓-green)
![Test Cases](https://img.shields.io/badge/Test%20Cases-✓-green)
![Bug Reports](https://img.shields.io/badge/Bug%20Reports-✓-green)

- Diseño de planes de prueba y casos de prueba
- Reporte detallado de bugs con evidencia
- Pruebas funcionales, negativas y de casos borde
...
- Validación de endpoints y respuestas JSON
- Encadenamiento de variables entre requests
...
- Consultas SQL con SELECT, JOIN, GROUP BY
- Validación de integridad de datos
- Creación de Triggers para validación automática
- Database testing con Sakila DB
...
Mi atención al detalle como QA viene de mi experiencia como PC Gamer. Cuando no estoy cazando bugs en aplicaciones web, suelo estar jugando, explorando nuevas tecnologías o resolviendo problemas de compatibilidad.
